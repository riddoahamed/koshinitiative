...
export const LESSONS: Lesson[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "<b>4. It’s only on a phone.</b> A Telegram group, a WhatsApp admin, a Facebook page with borrowed screenshots. No licence number, no office, no name you can look up with the regulator.",
