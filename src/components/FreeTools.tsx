...
import InvestmentComparator from "./InvestmentComparator";
...
const CompoundInterestCalc = () => {
  ...
  return (
    <div className="rounded-xl border border-kosh-teal/20 bg-white/95 p-6 md:p-8 backdrop-blur-sm">
        ...
        {[
          ...
          <label key={f.label} className="flex flex-col gap-1">
            ...
            <input
              ...
              className="rounded-lg border border-kosh-teal/20 bg-kosh-offwhite px-3 py-2 text-sm font-sans text-kosh-dark focus:outline-none focus:ring-1 focus:ring-kosh-mint"
            />
          </label>
        ))}
      </div>
