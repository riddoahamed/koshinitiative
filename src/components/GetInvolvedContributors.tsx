...
const GetInvolvedContributors = () => {
  ...
  return (
    ...
    >
      {/* Corner accent glows — top-left mint, bottom-right purple (matches "Try our platform") */}
      ...
      <div ref={ref} className="relative max-w-6xl mx-auto">
        ...
        <p className="text-kosh-muted text-base leading-relaxed mb-14 max-w-2xl font-sans">
          Kosh is early. The people who join now help define what it becomes. We are looking for people who believe financial education in Bangladesh should be exciting, accessible, and free of hidden agendas.
        </p>
