  ...
  return (
    ...
    >
      ...
      {/* ── The two outcomes, as two stickers ───────────────────────────
          ...
          ── STICKERS, NOT CARDS ────────────────────────────────────────────
          No border, no plate, no figure box. The first pass put each one in a
      ...
      {/* ── What kind of investment ────────────────────────────────────
          ...
          can act on it before they have picked a company. Gated on `classified`
          — see the note where showClasses is computed. */}
      {showClasses && (
